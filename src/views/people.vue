...
export default {
  ...
  data () {
    return {
      desc: '加里克研究所高级研究员的职位是为杰出的工程师、科学家和其他在一个或多个风险科学领域取得国际知名地位的专业人士设立的。高级研究员个人和集体的主要作用是为加里克研究所提供关于研究计划、具体项目的执行和教育活动的高级建议和指导。高级研究员预计将在研究所所在地花费部分时间，以帮助培养在开发、推广和应用风险科学方面的卓越文化和领导力。',
      list: [
        {
          cat: '首席研究员',
          people: [
