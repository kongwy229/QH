  ...
  <div class = "wrap-block">
    <div class = "content-block service-block">
      <div class = "service-block">
        ...
        <p class = "service-info-title">新闻公告1</p>
        <p class = "service-info-subtitle">清华新闻网10月16日电（记者 田姬熔 段颖）凝心聚力新时代，团结奋斗新征程。</p>
    ...
    <div class = "content-block service-case">
      <div class = "service-case">
        <div class = "block-line"></div>
        <p class = "case-title">新闻公告2</p>
        <p class = "case-subtitle">校党委书记邱勇在开幕会后表示，在全党全国人民的热切期盼和全世界的高度关注中</p>
        <div class = "case-list">
